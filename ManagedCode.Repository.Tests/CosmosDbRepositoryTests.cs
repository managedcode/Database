...
namespace ManagedCode.Repository.Tests
{
    public class CosmosDbRepositoryTests
    {
        ...
        private readonly CosmosDB.ICosmosDbRepository<TestCosmosDbItem> _repository = new CosmosDbRepository<TestCosmosDbItem>(
        ...
        {
            var localRepository = new CosmosDbRepository<TestCosmosDbItem>( new CosmosDbRepositoryOptions
            {
                ConnectionString = ConnecntionString
            });
